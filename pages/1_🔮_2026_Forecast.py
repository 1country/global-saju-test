...
# (1) 이 페이지 전용 상품 (3회 제한)
PRODUCT_PERMALINK_SPECIFIC = "2026_forecast"
# (2) 만능 패스 상품 (10회 제한)
...
def get_monthly_forecast_unique(element, lang):
    data = {
        "Wood": [("1월", "지인이나 친구가 금전 부탁을 해옵니다. 냉정하게 거절하지 않으면 돈도 잃고 사람도 잃습니다.", "People may ask for money. Refuse firmly to save both money and friends.", "⭐⭐"), ("2월", "강력한 경쟁자가 나타나 내 밥그릇을 노립니다. 감정적으로 대응하지 말고 실속만 챙기세요.", "A strong rival appears. Focus on benefits, not emotions.", "⭐⭐⭐"), ("3월", "사람들이 모이는 곳에서 말실수를 할 수 있습니다. '낮말은 새가 듣고 밤말은 쥐가 듣는다'를 명심하세요.", "Watch your words in social gatherings. A slip of the tongue causes trouble.", "⭐⭐"), ("4월", "뜻밖의 횡재수가 있습니다. 생각지도 못한 보너스나 공돈이 들어오니 기분 좋은 달입니다.", "Unexpected windfall! You might receive a bonus or unexpected money.", "⭐⭐⭐⭐⭐"), ("5월", "머리 회전이 빨라지고 아이디어가 폭발합니다. 기획이나 창작 활동에서 최고의 성과를 냅니다.", "Ideas flow endlessly. Best month for planning or creative work.", "⭐⭐⭐⭐⭐"), ("6월", "몸이 열 개라도 모자랄 만큼 바쁩니다. 과로로 쓰러질 수 있으니 영양제를 챙겨 드세요.", "Extremely busy. Take care of your health to avoid burnout.", "⭐⭐"), ("7월", "재물 흐름이 아주 안정적입니다. 헛돈 쓰지 말고 차곡차곡 저축하기 가장 좋은 시기입니다.", "Financial flow is stable. Best time to save money.", "⭐⭐⭐⭐"), ("8월", "직장에서 스트레스가 극에 달합니다. 욱하고 사표 던지지 마세요. 참는 자에게 복이 옵니다.", "Work stress peaks. Don't quit impulsively. Patience brings rewards.", "⭐⭐"), ("9월", "어깨가 무거워지지만 그만큼 인정받는 시기입니다. 승진이나 리더 자리를 제안받을 수 있습니다.", "Responsibilities grow, but so does recognition. Promotion is possible.", "⭐⭐⭐⭐"), ("10월", "문서 운이 아주 좋습니다. 부동산 계약이나 중요한 도장을 찍기에 길한 달입니다.", "Great luck with documents. Good for real estate or contracts.", "⭐⭐⭐⭐⭐"), ("11월", "꽉 막혔던 일이 귀인(윗사람)의 도움으로 시원하게 뚫립니다. 조언을 구하세요.", "Blocked problems are solved with help from a mentor.", "⭐⭐⭐⭐"), ("12월", "학업이나 자격증 시험에 행운이 따릅니다. 새로운 것을 배우기에 딱 좋은 연말입니다.", "Good luck with studies or exams. Perfect time to learn.", "⭐⭐⭐⭐")],
        "Fire": [("1월", "생각이 너무 많아 머리가 아픕니다. 스트레스성 두통을 주의하고 멍 때리는 시간을 가지세요.", "Too many thoughts cause headaches. Relax and clear your mind.", "⭐⭐"), ("2월", "귀인이 나타나 나를 끌어줍니다. 취업이나 합격 소식을 듣기에 아주 좋은 달입니다.", "A noble person appears. Great month for job offers or passing exams.", "⭐⭐⭐⭐⭐"), ("3월", "마음이 호수처럼 편안해집니다. 중요한 계약이나 약속을 잡기에 적합합니다.", "Peace of mind returns. Suitable for important contracts.", "⭐⭐⭐⭐"), ("4월", "자신감을 가지고 나를 드러내세요. 내 매력이 돈이 되고 기회가 되는 시기입니다.", "Express yourself. Your charm turns into money and opportunities.", "⭐⭐⭐⭐"), ("5월", "주변 사람들과 의견 충돌이 잦습니다. 이기려 하지 말고 '그럴 수도 있지' 하고 넘기세요.", "Conflicts increase. Don't try to win every argument.", "⭐⭐"), ("6월", "고집을 부리다가 다 된 밥에 재 뿌릴 수 있습니다. 동료와 협력해야만 이득을 봅니다.", "Stubbornness leads to failure. Cooperation is the only way.", "⭐⭐"), ("7월", "말 한마디로 천 냥 빚을 갚습니다. 영업이나 미팅에서 최고의 성과를 올립니다.", "Your words have power. Great results in sales or meetings.", "⭐⭐⭐⭐⭐"), ("8월", "큰 돈이 들어올 기회가 보입니다. 다만, 들어온 만큼 나갈 수 있으니 지갑을 닫으세요.", "Opportunity for big money, but expenses rise too. Manage spending.", "⭐⭐⭐"), ("9월", "재물운이 폭발하지만 지출도 큽니다. 기분파 쇼핑을 조심해야 하는 달입니다.", "Wealth luck explodes, but beware of emotional shopping.", "⭐⭐⭐⭐"), ("10월", "그동안의 노력에 대한 확실한 보상을 받습니다. 인센티브나 상을 받을 수 있습니다.", "Sure rewards for your efforts. Expect incentives or awards.", "⭐⭐⭐⭐⭐"), ("11월", "상사의 압박이나 업무량이 과도합니다. 지금은 납작 엎드려 때를 기다려야 합니다.", "High pressure from bosses. Stay low and wait for the right time.", "⭐⭐"), ("12월", "일은 힘들지만 명예는 올라갑니다. 사람들이 당신의 능력을 알아주기 시작합니다.", "Hard work leads to honor. People recognize your abilities.", "⭐⭐⭐⭐")],
        "Earth": [("1월", "이직이나 이사 등 이동수가 있습니다. 섣불리 움직이지 말고 신중하게 결정하세요.", "Possibility of moving or changing jobs. Decide carefully.", "⭐⭐⭐"), ("2월", "명예운이 상승합니다. 남들이 부러워할 만한 감투를 쓰거나 스카우트 제의가 옵니다.", "Honor rises. You might get a prestigious title or scout offer.", "⭐⭐⭐⭐⭐"), ("3월", "능력을 인정받아 승진하거나 중요한 직책을 맡게 됩니다. 리더십을 발휘하세요.", "Promotion or important role awaits. Show your leadership.", "⭐⭐⭐⭐"), ("4월", "오랜만에 친구들을 만나 회포를 풉니다. 지출은 좀 있겠지만 즐거운 한 달입니다.", "Meeting friends brings joy. Expenses rise, but it's happy.", "⭐⭐⭐"), ("5월", "집중력이 최고조에 달합니다. 미뤄뒀던 공부나 연구를 하기에 최적의 시기입니다.", "Concentration peaks. Best time to study or research.", "⭐⭐⭐⭐"), ("6월", "문서운이 대길합니다. 집을 사거나 중요한 계약을 하기에 더할 나위 없습니다.", "Great document luck. Perfect for buying a house.", "⭐⭐⭐⭐⭐"), ("7월", "혼자 끙끙 앓던 문제를 동료와 함께 해결합니다. 팀워크가 빛을 발합니다.", "Solve problems with colleagues. Teamwork shines.", "⭐⭐⭐⭐"), ("8월", "새로운 취미나 예술 활동을 시작해보세요. 의외의 재능을 발견하게 됩니다.", "Start a new hobby. You might discover unexpected talents.", "⭐⭐⭐⭐"), ("9월", "말주변이 좋아져서 어딜 가나 인기가 많습니다. 인맥을 넓히기 좋은 달입니다.", "Eloquence improves. Good month to expand your network.", "⭐⭐⭐⭐"), ("10월", "생각지도 못한 용돈이나 수익이 생깁니다. 작게라도 투자를 해봐도 좋습니다.", "Unexpected profit. Small investments are okay.", "⭐⭐⭐⭐"), ("11월", "눈앞에 큰 돈이 보이지만 욕심내면 낭패를 봅니다. 돌다리도 두들겨 보고 건너세요.", "Big money is visible, but greed causes failure. Be cautious.", "⭐⭐"), ("12월", "사업이나 프로젝트의 결실을 맺습니다. 수금하기 좋고 통장이 두둑해집니다.", "Reap rewards of projects. Good for collecting payments.", "⭐⭐⭐⭐⭐")],
        "Metal": [("1월", "먹을 복이 터졌습니다. 재물운도 좋으니 맛있는 것을 먹으며 자신을 대접하세요.", "Good luck with food and money. Treat yourself.", "⭐⭐⭐⭐"), ("2월", "요행을 바라지 마세요. 땀 흘린 만큼 정확하게 통장에 꽂히는 정직한 달입니다.", "Don't expect luck. You earn exactly what you work for.", "⭐⭐⭐"), ("3월", "예상치 못한 보너스나 성과급을 받습니다. 기분 좋은 비명을 지르게 됩니다.", "Unexpected bonus or incentive. Screaming with joy.", "⭐⭐⭐⭐⭐"), ("4월", "문서 계약 시 꼼꼼히 확인하세요. 작은 글씨를 못 봐서 손해 볼 수 있습니다.", "Check documents carefully. Missing fine print causes loss.", "⭐⭐"), ("5월", "관재구설(법적 다툼이나 말썽)이 따를 수 있습니다. 입을 무겁게 하고 조용히 지내세요.", "Legal issues or gossip may arise. Keep quiet.", "⭐⭐"), ("6월", "직장 스트레스가 최고조입니다. '이 또한 지나가리라'는 마음으로 멘탈을 잡으세요.", "Work stress is extreme. Keep your mental balance.", "⭐⭐"), ("7월", "위기 상황에서 윗사람이 구원의 손길을 내밉니다. 자존심 굽히고 도움을 받으세요.", "Superiors help in crisis. Swallow pride and accept help.", "⭐⭐⭐"), ("8월", "주관이 뚜렷해지는 건 좋지만, 남들이 볼 땐 똥고집입니다. 유연함이 필요합니다.", "Strong will is good, but don't be stubborn. Be flexible.", "⭐⭐"), ("9월", "누구와 붙어도 이길 수 있는 에너지가 있습니다. 경쟁이나 입찰에서 승리합니다.", "Energy to win against anyone. Victory in competition.", "⭐⭐⭐⭐⭐"), ("10월", "나를 물심양면으로 도와주는 귀인이 나타납니다. 인복이 터지는 달입니다.", "A noble person appears. Luck with people explodes.", "⭐⭐⭐⭐⭐"), ("11월", "나의 재능을 맘껏 펼치고 박수받습니다. 무대 위 주인공이 되는 시기입니다.", "Show off talents and get applause. You are the star.", "⭐⭐⭐⭐"), ("12월", "연말 모임에서 말실수로 오해를 살 수 있습니다. 술자리에서 특히 조심하세요.", "Slip of the tongue at parties causes misunderstanding.", "⭐⭐")],
        "Water": [("1월", "창의력이 화수분처럼 쏟아집니다. 예술이나 기획 분야라면 대박을 터뜨립니다.", "Creativity flows endlessly. Success in arts or planning.", "⭐⭐⭐⭐⭐"), ("2월", "새로운 일을 시작하거나 계획하기 딱 좋습니다. 시작이 반입니다.", "Perfect time to start new things. Well begun is half done.", "⭐⭐⭐⭐"), ("3월", "아랫사람이나 자녀에게 좋은 일이 생깁니다. 덕분에 나까지 웃게 됩니다.", "Good news for subordinates or children. It makes you smile.", "⭐⭐⭐⭐"), ("4월", "직장에서 승진하거나 중요한 책임을 맡습니다. 어깨가 무겁지만 기회입니다.", "Promotion or heavy responsibility. A burden but an opportunity.", "⭐⭐⭐⭐"), ("5월", "일확천금의 유혹이 옵니다. 투기나 도박은 패가망신의 지름길이니 절대 금지.", "Temptation of jackpot. Gambling leads to ruin.", "⭐⭐"), ("6월", "돈은 많이 들어오는데 나갈 구멍도 많습니다. 가계부를 꼼꼼히 써야 합니다.", "Money comes in but leaks out. Keep a strict budget.", "⭐⭐⭐"), ("7월", "명예가 올라가고 여기저기서 나를 찾습니다. 인기 관리를 잘해야 합니다.", "Honor rises and people seek you. Manage popularity.", "⭐⭐⭐⭐"), ("8월", "깊이 있는 공부나 연구에 몰두하면 큰 성과를 냅니다. 전문가로 인정받습니다.", "Focus on study brings results. Recognized as an expert.", "⭐⭐⭐⭐"), ("9월", "국가 자격증이나 학위 취득 등 문서와 관련된 경사가 있습니다.", "Good news regarding certifications or degrees.", "⭐⭐⭐⭐"), ("10월", "사사건건 방해하는 경쟁자가 나타나 스트레스를 줍니다. 무시하는 게 답입니다.", "Annoying competitors cause stress. Ignore them.", "⭐⭐"), ("11월", "친한 친구와 돈 문제로 의 상할 수 있습니다. 밥은 사되 돈은 빌려주지 마세요.", "Money issues with friends. Don't lend cash.", "⭐⭐"), ("12월", "자존심 때문에 사랑하는 사람과 다툴 수 있습니다. 이번 한 번만 져주세요.", "Pride causes fights with loved ones. Just lose this time.", "⭐⭐")]
    }
...
# 텍스트 리소스 (✅ 'btn_unlock' 키 추가!)
ui = {
    "ko": {
        "title": "디 엘리먼트: 2026년 정밀 운세",
        "lock": "🔒 유료 서비스 ($10)",
        "label": "이메일로 받은 라이센스 키 입력",
        "btn_unlock": "확인 (Unlock)", # ✅ 추가됨
...
if not st.session_state["unlocked_2026"]:
    with st.container(border=True):
        ...
        if st.button(t['btn_unlock']): # ✅ 수정된 키 사용
            if key == UNLOCK_CODE:
                ...
                if data_specific.get("success"):
                    ...
                    if data_all.get("success"):
                        if data_all.get("uses", 0) > 10:
                            st.error(f"🚫 All-Access Limit exceeded (Max 10 uses).")
                        else:
                            st.session_state["unlocked_2026"] = True
