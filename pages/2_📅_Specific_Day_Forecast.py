    ...
    scenarios = {
        "Same": { # 비견/겁재
            "ko": {
                ...
                "love_m": "연애 전선에 '경쟁자'의 그림자가 보입니다. 짝사랑 중이라면 강력한 라이벌이 등장해 마음을 졸일 수 있습니다. 연인이 있다면 당신의 자존심이 세지는 날이라, 별것 아닌 일로 자존심 싸움을 하다가 냉전 상태가 될 수 있습니다. 오늘 당신이 해야 할 일은 딱 하나, **'무조건 져주는 척하기'**입니다. 이기려 들면 관계에 금이 갑니다.",
                "love_f": "친구처럼 편안한 관계는 좋지만, 연인에게는 고집을 부리기 쉽습니다. 남자가 내 뜻대로 움직여주지 않으면 화가 치밀어 오를 수 있습니다. 싱글이라면 친구들과의 모임이나 동호회에서 나와 코드가 딱 맞는 사람을 만날 수 있습니다. 하지만 그 사람이 내 친구와도 썸이 있을 수 있으니 눈치 작전이 필요합니다.",
            ...
            "en": {
                ...
                "love_m": "A shadow of a **'Rival'** looms. If you have a crush, a competitor might appear. If you are in a relationship, your heightened pride could lead to unnecessary ego battles. Your mission today is simple: **'Pretend to lose.'** Trying to win an argument today will damage the relationship.",
                "love_f": "Friendly relationships are great, but you might be stubborn with your partner. You may get annoyed if he doesn't follow your lead. If single, you might meet someone who clicks with you perfectly at a social gathering. However, be aware that he might also be interested in your friend.",
        ...
        "Output": { # 식상
            "ko": {
                ...
                "love_m": "당신의 유머 감각과 센스가 폭발하여 여심을 사로잡습니다. 좋아하는 이성에게 적극적으로 대시하거나 이벤트를 해주기에 최고의 날입니다. 다만, 분위기에 취해 지키지 못할 약속을 하거나, 가벼운 언행으로 점수를 깎아먹지 않도록 주의하세요.",
                "love_f": "모성애가 발동하는 날입니다. 남자친구나 남편을 아이 다루듯 챙겨주려 합니다. 하지만 이것이 지나치면 **'잔소리 폭격'**이 될 수 있습니다. 오늘은 남자를 가르치려 들거나 지적하지 말고, 칭찬으로 조련하는 것이 훨씬 효과적입니다. 자녀가 있다면 자녀와 관련된 기쁜 일이 생깁니다.",
            ...
            "en": {
                ...
                "love_m": "Your humor and sense of style will captivate women. It's the best day to pursue a crush or plan a surprise event. Just be careful not to make promises you can't keep or appear too lighthearted, which could hurt your reputation.",
                "love_f": "Your maternal instincts kick in. You might want to take care of your partner like a child. However, this can turn into **'Nagging.'** Avoid lecturing or correcting him today; instead, use praise to guide him. Good news related to children is likely.",
        ...
        "Wealth": { # 재성
            "ko": {
                ...
                "love_m": "명리학에서 재성(돈)은 곧 **'여자'**를 의미합니다. 즉, 돈과 여자가 함께 들어오는 날입니다. 평소보다 이성에게 인기가 많아지며, 소개팅을 하면 미모와 능력을 겸비한 여성을 만날 확률이 높습니다. 썸녀가 있다면 오늘이 바로 고백 타이밍입니다.",
                "love_f": "남자를 볼 때 **'능력'**과 **'현실적인 조건'**을 따지게 됩니다. 감성에 호소하는 남자보다는, 비전이 확실하고 내 삶에 도움이 될 만한 남자에게 끌립니다. 오늘은 데이트할 때 맛집 투어나 쇼핑 등 오감을 만족시키는 코스가 행운을 불러옵니다.",
            ...
            "en": {
                ...
                "love_m": "In metaphysics, 'Wealth' also represents **'Women.'** Money and romance come together today. You will be more popular than usual. Blind dates are likely to introduce you to beautiful and capable women. If you have a crush, today is the day to confess.",
                "love_f": "You will judge men based on **'Capability'** and **'Conditions.'** Instead of emotional types, you'll be drawn to men with clear visions who can help your life. For dates, sensory experiences like gourmet tours or shopping will bring good luck.",
        ...
        "Power": { # 관성
            "ko": {
                ...
                "love_m": "일에 치여 연인에게 소홀해지기 쉽습니다. 혹은 자녀 문제로 골머리를 앓을 수 있습니다. 밖에서 받은 스트레스를 연인에게 풀지 않도록 각별히 조심해야 합니다. '나 힘드니까 건드리지 마'라는 태도는 싸움을 부릅니다.",
                "love_f": "**남자가 들어오는 날**입니다. 그것도 아주 강력하고 카리스마 있는 남자가 나타납니다. 나를 리드해주고 보호해주는 '상남자' 스타일일 확률이 높습니다. 하지만 연인이 있다면, 상대방이 나를 통제하거나 가르치려 들어 답답함을 느낄 수 있습니다. 오늘은 싸우면 백전백패니 져주는 게 낫습니다.",
            ...
            "en": {
                ...
                "love_m": "You might neglect your partner due to work overload. Issues with children could also cause headaches. Be extremely careful not to vent your work stress on your partner. Saying 'I'm tired, leave me alone' will invite a fight.",
                "love_f": "**Men are entering your life.** A powerful, charismatic man is likely to appear—someone who can protect and lead you. However, if you have a partner, he might try to control or lecture you, causing frustration. Fighting back today guarantees defeat; just let him win.",
        ...
        "Resource": { # 인성
            "ko": {
                ...
                "love_m": "연인에게 기대고 싶고 위로받고 싶은 마음이 커집니다. 모성애가 강한 여성을 만나거나, 연인이 나를 엄마처럼 살뜰히 챙겨줍니다. 오늘은 데이트 코스를 짜느라 머리 쓰지 말고, 상대방이 하자는 대로 따라가는 게 편합니다.",
                "love_f": "사랑받는 날입니다. 공주님 대접을 받을 수 있습니다. 상대방이 나의 기분을 세심하게 살피고 배려해줍니다. 소개팅을 한다면 예의 바르고 학식이 깊은, 배울 점이 많은 남자가 나옵니다.",
            ...
            "en": {
                ...
                "love_m": "You'll want to lean on your partner for comfort. You might meet a nurturing woman, or your partner will take care of you like a mother. Don't stress over planning dates; just follow her lead today.",
                "love_f": "You are loved. Expect to be treated like a princess. Your partner will be attentive to your feelings. If you have a blind date, expect a polite, educated man with much to offer.",
